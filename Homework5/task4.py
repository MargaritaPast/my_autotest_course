...
def scrabble(word):
    dict = {'а': 1, 'в': 1, 'е': 1, 'ё': 1, 'и': 1, 'н': 1, 'о': 1, 'р': 1, 'с': 1, 'т': 1,
    ...
    for i in enumerate(word):
        if i[1] in dict:  # Проверяю, есть ли буква в словаре
            points += int(dict[i[1]])  # Считаю стоимость найденных букв
        else:
            continue  # Продолжить, если символа нет в словаре
    return points
